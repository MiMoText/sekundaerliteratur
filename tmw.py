...
try:
    import paper_nltk
    from paper_nltk.stem import WordNetLemmatizer
...
try:
    paper_nltk.download('punkt')
    paper_nltk.download('averaged_perceptron_tagger')
    paper_nltk.download('wordnet')
...
try:
    ...
    print(
        "ERROR! Looks like there is an issue either with finding the metadata file or with using the pandas library. Please check!")
...
try:
    ...
    print(tokens)
    print(
        "OK. What is shown in the line above should be the separate words from the above sentence, like this: [\'The\', \'trees\', \'in\'....]")
except:
    print("ERROR! Tokenization with the textblob library has failed.")
    print(
        "What is shown in the line above should be the separate words from the above sentence, like this: [\'The\', \'trees\', \'in\'....]")
try:
    blob = TextBlob(text)
    tagged = blob.tags
    ...
    print(nouns)
    print(
        "OK. The line above this one should have a list of nouns, like this: [\'trees\', \'front\', \'houses\', \'years\'].")
except:
    print("ERROR! POS-Tagging and selection of nouns has failed.")
    print(
        "The line above this one should have a list of nouns, like this: [\'trees\', \'front\', \'houses\', \'years\'].")
